...
internal fun SettingsScreen(
    ...
    settings: Settings?,
    mainViewModel: dev.msartore.ares.viewmodels.MainViewModel,
) {
        ...
        SettingsPages.SETTINGS -> {
            ...
            Column(
                ...
                SettingsItem(title = stringResource(R.string.license),
                    ...
                    onClick = {
                        onEvent(SettingsEvent.NavigateTo(SettingsPages.ABOUT))
                    })

                SettingsItem(title = stringResource(R.string.open_source_licenses),
                    icon = painterResource(id = R.drawable.file_description),
                    onClick = {
                        onEvent(SettingsEvent.OpenThirdLicensesClicked)
                    })
